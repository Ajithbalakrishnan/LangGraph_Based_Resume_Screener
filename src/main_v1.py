...
#   st.text_input("GPT Model", "gpt-3.5-turbo", key="gpt_selection")
  ...
  st.divider()
  st.markdown("An LLM Chatbot based on LangGraph and LangChain that dynamically retrieves and processes resumes using RAG to perform resume screening. ")
  st.divider()
  st.markdown("Developed by AB")
